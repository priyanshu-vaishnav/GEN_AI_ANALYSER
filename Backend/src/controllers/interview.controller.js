...
const imageKit = require("../services/imagekit.services.js");
async function generateInterviewReport(req, res) {
  try {
    ...
    const uploadResponse = await imageKit.upload({
      file: req.file.buffer, // Buffer form me data gaya
      fileName: req.file.originalname,
      folder: "/resumeFiles",
    });

    const responseData =
      await interviewReportGenerateService.generateInterviewReport({
        selfDescription,

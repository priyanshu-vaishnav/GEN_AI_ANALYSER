    ...
    <div className="home-page">
      <nav className="hp-nav">
        ...
        <div className="hp-nav-links">
          <a href="#process" className="hp-nav-link">
            How it works
          </a>
          {user ? (
            <p></p>
      ...
      <section className="hp-hero">
        <div>
          ...
          <p className="hp-subtext">
            Drop in your interview transcript and get a full intelligence report
            back: technical gaps, behavioural read, and a day-by-day plan to
            close the distance before the next round.
          </p>

          <div className="hp-hero-actions">
            {user ? (
              <Link to="/Dashboard" className="hp-btn-primary">
                Open my Dashboard
              </Link>
            ) : (
            ...
            <a href="#process" className="hp-btn-secondary">
              See how it works →
            </a>
          </div>
          ...
          <div className="hp-stats-row">
            <div>
              <div className="hp-stat-num">10+</div>
        ...
        <div className="hp-terminal">
          ...
          <div className="hp-terminal-body">
            <div className="hp-line-q">
              Walk me through a time you disagreed with a teammate.
            </div>
            <div className="hp-line-a d1">
              Clear structure, weak resolution detail.
            </div>
            <div className="hp-line-a d2">
              Flag: outcome stated, ownership unclear.
            </div>
            <div className="hp-line-a d3">
              Suggested drill added to prep plan.
            </div>
      ...
      <section className="hp-section" id="process">
        ...
        <div className="hp-process-grid">
          <div className="hp-process-card">
            ...
            <p>
              Paste or upload the interview, technical or behavioural. No
              formatting required, no cleanup needed.
            </p>
          </div>
          <div className="hp-process-card">
            ...
            <p>
              Every answer is read for substance, structure, and gaps against
          ...
          <div className="hp-process-card">
            ...
            <p>
              A match score, a skills-gap breakdown, and a day-by-day plan that
      ...
      <section className="hp-footer-cta">
        <div className="hp-footer-panel">
          ...
          <p>
            Open a case file in under a minute. No credit card, no waiting room.
          </p>
          <Link to="/Register" className="hp-btn-primary">
            Register
          </Link>
